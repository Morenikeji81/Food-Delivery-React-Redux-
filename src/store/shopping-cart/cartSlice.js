  ...
  reducers: {
    ...
    addItem(state, action) {
      ...
      if (!existingItem) {
        ...
        // NOTE: If you use just redux yo should not mute state array 
        // instead of clone the state array, but if you use redux 
        // toolkit that will not a problem because redux toolkit clone 
        // the array behind the scene
